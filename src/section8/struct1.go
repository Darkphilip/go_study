...
func main() {
	...
	yoon := Account{number: "245-903", interest: 0.025}
	wee := Account{"245-904", 15000000, 0.03}

	fmt.Println("ex1:", kim)
	fmt.Println("ex1:", lee)
	fmt.Println("ex1:", yoon)
	fmt.Println("ex1:", wee)
	fmt.Println()
	...
	fmt.Println("ex2:", int(yoon.Calculate()))
	fmt.Println("ex2:", int(wee.Calculate()))
